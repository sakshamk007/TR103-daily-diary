...
## Created checkbid.ejs and /checkbid route
                            ...
                            <tr class="<%= row.auction %>">
                                ...
                                <td class="lg:p-2 p-1 text-center">
                                    <form action="/startbid" method="POST">
                                        ...
                                        <button type="submit" class="interested bg-gradient-to-b from-cyan-700 to-cyan-900 rounded-lg lg:p-2 p-1 transform transition-transform duration-150 ease-in-out active:scale-95">Interested</button>
                                    </form>
                                </td>
                            </tr>
                        <% }); %>
