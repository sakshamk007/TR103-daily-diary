...
## Created participatedbids.ejs and /participatedbids route
                                ...
                                <td class="lg:p-2 p-1 text-center">
                                    <div class="flex flex-col justify-center items-center gap-2">
                                        <form action="/participated-bids-status" method="POST">
                                            ...
                                            <button type="submit" class="interested bg-gradient-to-b from-cyan-700 to-cyan-900 rounded-lg lg:p-2 p-1 transform transition-transform duration-150 ease-in-out active:scale-95">Check</button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
